...
public class Reusable_Actions_Loggers {
    ...
    //creating Scroll method using javascriptExecutor
    public static void  scrollMethod(WebDriver driver, String x, String y,ExtentTest logger, String scroll){
        //scroll to window
        JavascriptExecutor jse = (JavascriptExecutor)driver;
        //scroll to use the vew by pixels
    ...
    public  static void PopUpClickMethod (WebDriver driver , String xpath ,ExtentTest logger , String elementName){
        ...
        try{
            ...
            logger.log(LogStatus.PASS," Pop up did not show up moving to the next step " + elementName + " " + e);
            getScreenShot(driver,elementName,logger);
        }

    }//end of PopUpClickMethod
